...
def create_app(config_class=Config):
    ...
    app.task_queue = rq.Queue('zetravox-tasks', connection=app.redis)
    ...
    if not app.debug and not app.testing:
        if app.config['MAIL_SERVER']:
            ...
            mail_handler = SMTPHandler(
                ...
                toaddrs=app.config['ADMINS'], subject='zetravox Failure',
        ...
        if app.config['LOG_TO_STDOUT']:
            ...
            if not os.path.exists('logs'):
                os.mkdir('logs')
            file_handler = RotatingFileHandler('logs/zetravox.log',
        ...
        app.logger.info('zetravox startup')
